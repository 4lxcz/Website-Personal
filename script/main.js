...
const messages = [
    ...
    "ini",
    "terakhir",
    "hehee tapi boong, yuk usaha lagi",
    "hmm",
    "yaudah deh",
    "tadi mainnya seru gaa?",
    "biar kamu ada jeda istirahat",
    "aku kirim ini selepas kamu pulangg aja",
    "sebelumnya maaf kalo kamu risih 😔",
    "di halaman selanjutnya bakal ada sesuatu",
    "kalo ga suka, gausah balas pesan wa pribadi aku",
